...
function boot(canvas) {
  ...
  const KEYS = [
    ...
    { t: 0.106, sec: 'about', aboutSlot: 0, p:-0.0800, cz: 7.5, cy:  0.08, x: -2.42, y: -1.04, z:  0.10, rx: -0.07, ry:  0.76, s: 0.31, sp: 0.78, br: 0.52, op: 0.76, ro: -0.010 },
    /* При прямом переходе модель садится ниже заголовка и левее copy. У
       передней короны больший оптический вес, поэтому запас по X нужен
       заметнее, чем кажется по геометрическому центру. */
    { t: 0.120, sec: 'about', aboutSlot: 1, p: 0.1200, cz: 7.5, cy:  0.08, x: -1.64, y: -0.38, z: -0.05, rx: -0.07, ry:  0.76, s: 0.58, sp: 0.84, br: 0.52, op: 0.76, ro: -0.010 },
    /* Неподвижная нижняя левая опора. Она даёт сцене время раскрыться и
    ...
    { t: 0.124, sec: 'about', aboutBeat: 'centerHold', p: 0.6500, cz: 7.5, cy:  0.08, x: -1.64, y: -0.38, z: -0.05, rx: -0.07, ry:  0.76, s: 0.58, sp: 0.84, br: 0.52, op: 0.76, ro: -0.010 },
  ...
  const ABOUT_DESKTOP_POSES = [
    ...
    { cz:7.5, cy: .08, x:-2.42, y:-1.04, z: .10, rx:-.07, ry:.76, s:.31, sp:.78, br:.52, op:.76, ro:-.010 },
    { cz:7.5, cy: .08, x:-1.64, y:-.38, z:-.05, rx:-.07, ry:.76, s:.58, sp:.84, br:.52, op:.76, ro:-.010 },
  ...
  function resolveKeys() {
    ...
    const aboutKeyP = compactAbout ? [0.07, 0.22, 0.40, 0.54] : [-0.08, 0.12, 0.91, 0.982];
