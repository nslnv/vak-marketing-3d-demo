...
function boot(canvas) {
  ...
  const KEYS = [
    ...
    /* About — уход и возвращение проходят по одной оси. Прибор сначала
       уходит в глубину кадра, затем появляется из неё уже собранным,
       строго фронтально и по центру сцены. Нет бокового пролёта, который
       раньше пересекал экран и давал ощущение поспешного скачка. */
    ...
    /* В начале секции предмет остаётся маленьким и дальним ровно в центре:
       это даёт читаемый момент «ухода внутрь» до спокойного обратного хода. */
    { t: 0.108, sec: 'about', aboutEntryLanding: true, p: 0.0700, cz: 7.5, cy:  0.00, x:  0.00, y:  0.00, z: -3.75, rx:  0.00, ry:  0.00, s: 0.20, sp: 0.78, br: 0.48, op: 0.56, ro:  0.000 },
    { t: 0.112, sec: 'about', aboutSlot: 0, aboutEntrySettle: true, p: 0.1100, cz: 7.5, cy:  0.00, x:  0.00, y:  0.00, z: -2.30, rx:  0.00, ry:  0.00, s: 0.30, sp: 0.80, br: 0.52, op: 0.68, ro:  0.000 },
    /* Раскрытие начинается после фронтальной посадки. Вся механика остаётся
       на центральной оси, поэтому ракурс выглядит собранным и ровным. */
    { t: 0.120, sec: 'about', aboutSlot: 1, p: 0.3900, cz: 7.5, cy:  0.00, x:  0.00, y:  0.04, z: -0.05, rx:  0.00, ry:  0.00, s: 0.56, sp: 0.84, br: 0.54, op: 0.78, ro:  0.000 },
    ...
    { t: 0.124, sec: 'about', aboutBeat: 'centerHold', p: 0.6500, cz: 7.5, cy:  0.00, x:  0.00, y:  0.04, z: -0.05, rx:  0.00, ry:  0.00, s: 0.56, sp: 0.84, br: 0.54, op: 0.78, ro:  0.000 },
    ...
    { t: 0.127, sec: 'about', aboutSlot: 2, p: 0.9100, cz: 7.5, cy: 0.00, x:  0.00, y:  0.02, z: -0.08, rx: 0.000, ry: 0.02, s: 0.54, sp: 0.86, br: 0.51, op: 0.72, ro:  0.000 },
  ...
  const ABOUT_DESKTOP_POSES = [
    /* Входная поза находится в глубине на центральной оси. Она нужна только
       для обычной прокрутки: при переходе по #about сразу видна ровная сцена. */
    { cz:7.5, cy:0, x:0, y:0, z:-2.30, rx:0, ry:0, s:.30, sp:.80, br:.52, op:.68, ro:0 },
    { cz:7.5, cy:0, x:0, y:.04, z:-.05, rx:0, ry:0, s:.56, sp:.84, br:.54, op:.78, ro:0 },
    { cz:7.5, cy:0, x:0, y:.02, z:-.08, rx:0, ry:.02, s:.54, sp:.86, br:.51, op:.72, ro:0 },
