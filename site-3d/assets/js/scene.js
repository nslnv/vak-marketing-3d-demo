...
function boot(canvas) {
  ...
  const KEYS = [
    ...
    { t: 0.106, sec: 'about', aboutSlot: 0, p:-0.0800, cz: 7.5, cy:  0.08, x: -1.70, y: -0.42, z:  0.10, rx: -0.07, ry:  0.76, s: 0.31, sp: 0.78, br: 0.52, op: 0.76, ro: -0.010 },
    ...
    { t: 0.120, sec: 'about', aboutSlot: 1, p: 0.1200, cz: 7.5, cy:  0.08, x: -0.92, y:  0.24, z: -0.05, rx: -0.07, ry:  0.76, s: 0.58, sp: 0.84, br: 0.52, op: 0.76, ro: -0.010 },
    ...
    { t: 0.127, sec: 'about', aboutSlot: 2, p: 0.9100, cz: 7.5, cy: 0.07, x: -0.72, y:  0.18, z: -0.08, rx:-0.075, ry: 0.78, s: 0.56, sp: 0.86, br: 0.51, op: 0.72, ro: -0.009 },
  ...
  const ABOUT_DESKTOP_POSES = [
    ...
    { cz:7.5, cy: .08, x:-1.70, y:-.42, z: .10, rx:-.07, ry:.76, s:.31, sp:.78, br:.52, op:.76, ro:-.010 },
    { cz:7.5, cy: .08, x:-.92, y:  .24, z:-.05, rx:-.07, ry:.76, s:.58, sp:.84, br:.52, op:.76, ro:-.010 },
    { cz:7.5, cy:.07, x:-.72, y:.18, z:-.08, rx:-.075, ry:.78, s:.56, sp:.86, br:.51, op:.72, ro:-.009 },
