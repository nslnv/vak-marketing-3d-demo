...
function boot(canvas) {
  ...
  const KEYS = [
    ...
    /* Якорная посадка удерживает цельный прибор под H2. Поэтому прямой
       ...
       последующий уход к центру мягким в обоих направлениях scroll. */
    { t: 0.112, sec: 'about', p: 0.1900, cz: 7.5, cy:  0.08, x: -2.42, y: -1.04, z:  0.10, rx: -0.07, ry:  0.76, s: 0.31, sp: 0.78, br: 0.52, op: 0.76, ro: -0.010 },
