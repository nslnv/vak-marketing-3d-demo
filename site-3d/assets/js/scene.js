...
function boot(canvas) {
  ...
  const stream = new THREE.Points(pGeo, new THREE.ShaderMaterial({
    ...
    vertexShader: `
      ...
      void main(){
        ...
        /* Пакеты сигнала: по собранным лучам от линзы наружу бегут светлые
           импульсы. Фаза общая для луча, поэтому это читается как передача,
           а не как случайное мерцание отдельных точек. */
        float packet = smoothstep(0.55, 1.0, sin((z - uT * 1.7) * 1.9 + aRay * 1.3));
  ...
  const KEYS = [
    ...
    /* About — прибор сначала уходит в глубину по центральной оси, а затем
       возвращается в левую свободную зону под заголовком. Там он стоит ровно
       и горизонтально: справа остаётся текст, ниже — чистое место для
       раскрытия деталей без бокового скачка через весь экран. */
    { t: 0.102, sec: 'about', aboutEntryArcStart: true, p:-0.1000, cz: 7.5, cy:  0.04, x:  1.48, y:  0.02, z: -1.30, rx: -0.08, ry:  0.48, s: 0.35, sp: 0.82, br: 0.52, op: 0.70, ro:  0.000 },
    { t: 0.104, sec: 'about', aboutEntryArcTop: true,   p:-0.0400, cz: 7.5, cy:  0.02, x:  0.48, y:  0.02, z: -3.85, rx: -0.03, ry:  0.14, s: 0.19, sp: 0.80, br: 0.48, op: 0.52, ro:  0.000 },
    { t: 0.106, sec: 'about', aboutEntryArcSide: true,  p: 0.0150, cz: 7.5, cy:  0.00, x:  0.04, y:  0.00, z: -5.10, rx:  0.00, ry:  0.01, s: 0.12, sp: 0.78, br: 0.44, op: 0.34, ro:  0.000 },
    /* Возврат из глубины начинается только после того, как предмет исчез
       в центральной точке: смещение влево происходит уже маленькой моделью. */
    { t: 0.108, sec: 'about', aboutEntryLanding: true, p: 0.0700, cz: 7.5, cy:  0.00, x: -1.28, y: -0.08, z: -3.75, rx:  0.00, ry:  0.42, s: 0.20, sp: 0.78, br: 0.48, op: 0.56, ro:  0.000 },
    { t: 0.112, sec: 'about', aboutSlot: 0, aboutEntrySettle: true, p: 0.1100, cz: 7.5, cy:  0.00, x: -1.92, y: -0.10, z: -2.30, rx:  0.00, ry:  0.64, s: 0.30, sp: 0.80, br: 0.52, op: 0.68, ro:  0.000 },
    /* В левой зоне модель стоит горизонтально, без крена. Геометрия может
       раскрываться ниже и вправо, не затрагивая текстовую колонку. */
    { t: 0.120, sec: 'about', aboutSlot: 1, p: 0.3900, cz: 7.5, cy:  0.00, x: -1.92, y: -0.05, z: -0.05, rx:  0.00, ry:  0.76, s: 0.56, sp: 0.84, br: 0.54, op: 0.78, ro:  0.000 },
    ...
    { t: 0.124, sec: 'about', aboutBeat: 'centerHold', p: 0.6500, cz: 7.5, cy:  0.00, x: -1.92, y: -0.05, z: -0.05, rx:  0.00, ry:  0.76, s: 0.56, sp: 0.84, br: 0.54, op: 0.78, ro:  0.000 },
    ...
    { t: 0.482, sec: 'cases', p: 0.1058, cz: 4.8, cy:  0.00, x:  1.00, y:  0.00, z:  2.35, rx: -0.02, ry:  0.16, s: 0.80, sp: 1.10, br: 0.58, op: 0.44, ro:  0.048 },
    /* кейсы: мы внутри тубуса, кольца оправ идут тоннелем по краям кадра.
       Карточки имеют собственную плотную подложку, поэтому прибор здесь
       плотнее прежнего призрака и металл со светом читаются. */
    { t: 0.548, sec: 'cases', p: 0.6200, cz: 4.0, cy:  0.00, x:  0.00, y:  0.00, z:  1.55, rx:  0.02, ry:  0.02, s: 1.32, sp: 1.00, br: 0.30, op: 0.52, ro: -0.058 },
    ...
    { t: 0.777, sec: 'team', p: 0.5259, cz: 7.8, cy: -0.02, x: -5.85, y: -1.25, z: -4.8, rx: -0.34, ry: -2.40, s: 0.16, sp: 1.45, br: 0.22, op: 0.000, portraitOp: 0.000, ro:  0.000 },
  ...
  const ABOUT_DESKTOP_POSES = [
    /* Входная поза находится в левой сценической зоне под H2. Она нужна
