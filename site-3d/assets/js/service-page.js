...
function strategyProofTitle() {
  return language === 'en'
    ...
    : '<span class="sp-decision-frame__line">Не набор услуг,</span><span class="sp-decision-frame__line"><span class="sp-decision-frame__accent">а последовательность решений</span></span>';
}
